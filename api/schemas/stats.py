...
class ChatStatRow(BaseModel):
    ...
    deleted_count: int
    edited_count: int
    first_message_at: datetime | None = Field(None, description="ISO 8601 timestamp of the earliest archived message.")
    last_message_at: datetime | None = Field(None, description="ISO 8601 timestamp of the most recent archived message.")
...
class StatsOut(BaseModel):
    ...
    total_chats: int
    total_senders: int
    archiving_since: datetime | None = Field(None, description="ISO 8601 datetime of the earliest archived message.")
